...
class ReservasControllerTest < ActionController::TestCase
  ...
  test "should create reserva" do
    assert_difference('Reserva.count') do
      post :create, reserva: { escenario_id: @reserva.escenario_id, fecha: @reserva.fecha, horafin: @reserva.horafin, horainicio: @reserva.horainicio, user_id: @reserva.user_id }
    end
  ...
  test "should update reserva" do
    patch :update, id: @reserva, reserva: { escenario_id: @reserva.escenario_id, fecha: @reserva.fecha, horafin: @reserva.horafin, horainicio: @reserva.horainicio, user_id: @reserva.user_id }
    assert_redirected_to reserva_path(assigns(:reserva))
  end
